        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className={lang === 'ar' ? 'text-right' : 'text-left'}>
            <div className="inline-block mb-6">
              <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] bg-primary/5 px-4 py-2 rounded-full">
                {t('about.subtitle')}
              </span>
            </div>

            <h2 className="text-5xl lg:text-6xl font-black text-slate-900 mb-10 leading-tight tracking-tight uppercase font-display">
              {t('about.title')}
            </h2>
            ...
            <div className="space-y-8 text-xl text-slate-500 leading-relaxed font-arabic font-medium max-w-2xl">
              ...
              >
                <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:scale-110 transition-transform">
                  <span className="material-icons text-8xl text-slate-900">
                    format_quote
                  </span>
                </div>
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 border-t border-slate-100 pt-12">
              ...
              <div className="flex flex-col items-center lg:items-start group">
                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-secondary group-hover:text-white transition-all duration-500 shadow-sm">
              ...
              <div className="flex flex-col items-center lg:items-start group">
                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-accent group-hover:text-white transition-all duration-500 shadow-sm">
                  <span className="material-icons-round text-3xl">
                    auto_awesome
                  </span>
                </div>
